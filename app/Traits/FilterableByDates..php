...
trait FilterableByDates
{
    ...
    public function scopeStartOfMonthToDate($query, $column = 'created_at')
    {
    ...
    public function scopeStartOfQuarterToDate($query, $column = 'created_at')
    {
        $now = Carbon::now();
    ...
    public function scopeStartOfYearToDate($query, $column = 'created_at')
    {
    ...
    {
        return $query->whereBetween($column, [Carbon::now()->subYear()->startOfYear(), Carbon::now()->subYear()->endOfYear()]);
    }
}
